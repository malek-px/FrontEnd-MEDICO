 ...
 * Use the [Fragment_acceuil_patient.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fragment_acceuil_patient : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_acceuil_patient, container, false)
        // Inflate the layout for this fragment

        //declaration des elements
        recylcerMedication =view.findViewById(R.id.acceuil_patient_recyclerView_Today)
    ...
    companion object {
         ...
         * @return A new instance of fragment Fragment_acceuil_patient.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fragment_acceuil_patient().apply {
